...
class PosCalculator(Node):
    # TODO: comments! + orient in this
    def __init__(self):
        super().__init__('pos_calculator')
        self.vel_sub = self.create_subscription(Vector3, 'velocity', 10)
        self.nam_t_sub = self.create_subscription(String, '/name_and_time', 10)
        self.position = Pose()
        self.time_step = 0.5
    ...
    # TODO: what does this do? also finish and explain with comments
